...
$breadcrumb = '<p id="breadcrumb"><a href="bacheca.php" tabindex="3">Bacheca</a>
<img src="img/freccia_dx.png" alt="" /> Post ' . $title . '</p>';
...
$post = str_replace('<volontari />', empty($blob['volontari']['html']) ? '' : $blob['volontari']['html'], $post);
