...
$menu = createMenu(true, true, true, false, true, true);

// Codice HTML del breadcrumb
$breadcrumb = '<p id="breadcrumb">Aiuto</p>';

// Codice HTML del content
$content = file_get_contents('includes/contentHelp.html');
...
$page_body = str_replace('<skip />', 'help', $page_body);
